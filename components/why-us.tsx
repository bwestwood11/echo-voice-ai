...
const WhyUs = () => {
  return (
    ...
    <p className="font-base max-w-xl mx-auto text-gray-600">The most natural sounding AI voices to generate amazing content for your business, YouTube channel, podcast, </p>
