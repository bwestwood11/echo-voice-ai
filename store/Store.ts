          ...
          if (
            ...
            editorElement.properties.splittedTexts =
              getTextObjectsPartitionedByCharacters(
                editorElement.fabricObject as any,
                editorElement
              );
    ...
    for (let index = 0; index < store.editorElements.length; index++) {
      ...
      switch (element.type) {
        case "video": {
          ...
          // }
          interface ICustomImageOptions extends fabric.IImageOptions {
            customFilter?: string;
          }
        ...
        case "image": {
          ...
          // }
          interface ICustomImageOptions extends fabric.IImageOptions {
            customFilter?: "none" | "blackAndWhite" | "sepia" | "invert" | "saturate";
          }
